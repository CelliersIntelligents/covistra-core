...
CMBF.prototype.installPlugin = P.method(function(path, options) {
    var _this = this;
    options = options || {};
    ...
    return this.waitFor(plugin.deps || options.deps || [], {debug: entry.name}).then(function() {
                ...
                .then(function() {
                    ...
                    return _this.callHook('register-plugins', {server:server, config:config}, function() {
                        ...
                        return P.join(
                            ...
                            _this.installPlugin('covistra-system', {runtime: pluginOpts}),
                            _this.installPlugin('covistra-mongodb', {runtime: pluginOpts}),
                            _this.installPlugin('covistra-security', {runtime: pluginOpts}),
                            _this.installPlugin('covistra-admin', {runtime: pluginOpts})
                        ).then(function() {
